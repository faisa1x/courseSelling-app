...
function Purchases() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-r from-[#6e8bc9] to-[#ef959d]">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 bg-gradient-to-r from-[#6e8bc9] to-[#ef959d] p-5 transform ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0 transition-transform duration-300 ease-in-out w-64 z-50`}
      >
        <nav>
          <ul className="mt-16 md:mt-0 bg-gradient-to-r from-[#6e8bc9] to-[#ef959d]">
            <li className="mb-4">
            ...
            <li className="mb-4">
              <a href="#" className="flex items-center text-blue-800">
