...
function Courses() {
  ...
  return (
    <div className="flex bg-gradient-to-r from-[#6e8bc9] to-[#ef959d]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gradient-to-r from-[#6e8bc9] to-[#ef959d]  w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
